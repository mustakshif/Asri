...
![luminous frost glass](https://cdn.jsdelivr.net/gh/mustakshif/Asri-for-SiYuan@main/doc/luminous-frost-glass_v2.jpg)
...
[^3]: 由于主题功能有限，部分界面的 UI 布局方向无法完全修改。

[^4]: 自动隐藏滚动条需要在 macOS「系统设置-外观」中，将「显示滚动条」设置为「滚动时」。
