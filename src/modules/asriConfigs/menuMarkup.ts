...
const paletteMenuItem = (paletteID: string, i18n: I18nMap) => {
...
export function buildTopbarFusionPlusMenuHTML(i18n: I18nMap) {
  return `
...
export function buildAsriConfigMenuHTML(i18n: I18nMap, userCustomColor: string, chromaLabel: string) {
  return `
        ...
        ${Object.keys(asriPrstPalettes)
          .map((paletteID) => paletteMenuItem(paletteID, i18n))
          .join("")}
        <button class="b3-menu__separator asri-config"></button>
        ...
        <button class="b3-menu__item asri-config" data-type="nobg" id="asriChroma">
            ...
            <div aria-label="${chromaLabel}" class="b3-tooltips b3-tooltips__n">
