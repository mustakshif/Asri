...
export const asriDoms = {
    ...
    get layoutCenter() { return _layoutCenter ??= document.querySelector('.layout__center') as HTMLElement; },
    ...
    get layoutDockL() { return _layoutDockL ??= document.querySelector('.layout__dockl') as HTMLElement; },
    get layoutDockR() { return _layoutDockR ??= document.querySelector('.layout__dockr') as HTMLElement; },
    get layoutDockB() { return _layoutDockB ??= document.querySelector('.layout__dockb') as HTMLElement; },
